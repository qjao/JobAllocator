...
const target = `<div className="mt-6 mb-2 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden bg-white flex justify-center">
            <img 
...
const replacement = `<div className="mt-6 mb-2 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden bg-white block">
            <img 
              src={\`https://tdtools.co.uk/roster/diagramimg.php?pdfname=\${currentJob.pdfname}&page=\${currentJob.page}\`} 
              alt={\`Diagram Preview for \${selectedDiagram}\`} 
